...
// DESIGN SYSTEM E — Deloitte Green/Teal (Green primary, teal accents, Open Sans)
const S = {
  brandGreen: "86BC25",
  teal: "0097A9",
  black: "000000",
...
function addInsightPanel(slide, title, insights) {
  ...
  slide.addShape("rect", { x: panelX, y: S.BY, w: 0.06, h: panelH, fill: { color: S.mediumGray } });
...
pres.title = "FY26 Sales Forecast - Design System E";
...
// SLIDE 1: COVER
{
  ...
  sl.addShape("rect", { x: S.COVER_ML, y: 4.0, w: 4.0, h: 0.03, fill: { color: S.mediumGray } });
...
// SLIDE 2: EXECUTIVE SUMMARY
{
  ...
  cards.forEach((c, i) => {
    ...
    sl.addShape("rect", { x: cx, y: S.BY, w: cw, h: 0.06, fill: { color: S.mediumGray } });
...
const fileName = "FY26_Sales_Forecast_SystemE.pptx";
